...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute rounded-full border-none bg-opacity-0 bg-white ",
        orientation === "horizontal"
      ...
      {...props}
    >
      <ChevronLeftIcon className="w-20 dark:text-white text-black" />
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 rounded-full bg-white bg-opacity-0 border-none",
        orientation === "horizontal"
